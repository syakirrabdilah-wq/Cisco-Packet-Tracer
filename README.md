...
![Network Topology](docs/simulasi_jaringan_MAN.jpg) <!-- Ganti dengan screenshot topologi keseluruhan nantinya -->
...
📦 multi-branch-network
 ...
 ┃ ┣ 📜 router_tegal.cfg
 ┃ ┗ 📜 router_bali.cfg
 ┣ 📂 docs                    # Dokumentasi screenshot konfigurasi dan topologi
